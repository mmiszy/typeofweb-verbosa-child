...
function typeofweb_add_react_facebook_group_link() {
  ...
  if ($series && ($series === 'Piece of cake' || $series === 'CI/CD z Buddy.works')) {
    $series = NULL;
  }
?>
    ...
    <div class="textwidget">
      <p style="font-size: 1.8em; text-indent: 0; text-align: center; margin: 0;">
        <?php
          ...
          // }
        ?>
        <p style="font-size: 1.8em; text-indent: 0; text-align: center; margin: 0; font-weight: 900;">Szkolenie JavaScript 9-11 marca w Gdańsku!<br> 👉&nbsp;<a href="https://typeofweb.com/szkolenia/javascript.html">Zobacz szczegóły</a>&nbsp;👈</p>
      </p>
    </div>
  </section>
</aside> -->
